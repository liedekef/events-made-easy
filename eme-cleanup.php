...
<h1><?php esc_html_e( 'Cleanup actions', 'events-made-easy' ); ?></h1>
	...
	<input type="submit" value="<?php esc_attr_e( 'Apply', 'events-made-easy' ); ?>" name="doaction" id="eme_doaction" class="button-primary action" onclick="return confirm('<?php esc_attr_e( $areyousure ); ?>');">
	</form>
