...
?>
                ...
                <?php if ( ! $edit_recurrence ) { ?>
                        <input type="submit" class="button-primary" id="event_trash_button" name="event_trash_button" value="<?php esc_attr_e( 'Move event to trash bin', 'events-made-easy' ); ?> &raquo;" onclick="return EMEAdmin.utils.areyousure('<?php echo $trash_button_text; ?>');">
<?php
...
?>
                    ...
                    <?php if ( $edit_recurrence && $recurrence_id > 0 ) { ?>
                            <input type="submit" class="button-primary" id="event_deleteRecurrence_button" name="event_deleteRecurrence_button" value="<?php esc_attr_e( 'Delete Recurrence', 'events-made-easy' ); ?> &raquo;" onclick="return EMEAdmin.utils.areyousure('<?php echo $deleteRecurrence_button_text; ?>');">
                    <?php } ?> 
            <?php } ?>
    </p>
    </div>
