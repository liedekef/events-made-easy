...
function eme_formfields_edit_layout( $field_id = 0, $message = '', $t_formfield = [] ) {
   ...
   <p>" . esc_html__( 'For more information about form fields, see ', 'events-made-easy' ) . "<a target='_blank' href='https://www.e-dynamics.be/eme-docs/custom-attributes/'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a></p>
   ';
