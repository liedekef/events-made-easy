      ...
      <table class='form-table'>
            ...
            <tr class='form-field'>
               ...
               <td><textarea name='list' id='description' rows='5' >" . esc_html( $holidays['list'] ) . '</textarea><br>
                 ' . __( 'Basic format: YYYY-MM-DD, one per line', 'events-made-easy' ) . '<br>' . esc_html__( 'For more information about holidays, see ', 'events-made-easy' ) . " <a target='_blank' href='https:/eme-docs/holidays/'>" . esc_html__( 'the documentation', 'events-made-easy' ) . "</a></td>
            </tr>
         </table>
