...
<div id="mail-tabs" style="display: none;" <?php echo $data_forced_tab; ?>>
	...
	<td><?php echo eme_ui_multiselect_key_value( $membership_ids, 'eme_eventmail_send_memberships', $memberships, 'membership_id', 'name', 5, '', 0, 'eme_select2_memberships_class', $aria_label ); ?></td></tr>
		...
		<input type='text' id='eventmail_chooseperson' name='eventmail_chooseperson' placeholder="<?php esc_html_e( 'Start typing a name', 'events-made-easy' ); ?>">
	...
	<form id='send_generic_mail' name='send_generic_mail' action="#" method="post" onsubmit="return false;">
		...
		<input type='text' id='chooseperson' name='chooseperson' placeholder="<?php esc_html_e( 'Start typing a name', 'events-made-easy' ); ?>">
