...
function eme_update_options( $db_version ) {
    if ( $db_version ) {
        ...
        if ( $db_version < 419 ) {
            delete_option( 'eme_payconiq_merchant_id' );
            $rename_options = [
