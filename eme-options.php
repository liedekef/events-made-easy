...
function eme_options_register() {
	...
	switch ( $tab ) {
		...
		case 'rsvp':
			...
			break;
		case 'tasks':
				$options = [ 'eme_task_registered_users_only', 'eme_task_requires_approval', 'eme_task_allow_overlap', 'eme_task_form_taskentry_format', 'eme_task_form_format', 'eme_task_signup_format', 'eme_task_signup_recorded_ok_html', 'eme_task_signup_cancelled_ok_html', 'eme_task_reminder_days' ];
			break;
		case 'mail':
...
<table class='form-table'>
			<?php
			eme_options_input_text( __( 'Task Signup Pending Email Subject', 'events-made-easy' ), 'eme_task_signup_email_subject', __( 'The subject of the email sent to the respondent when that person signs up for a task that requires approval.', 'events-made-easy' ) . '<br>' . __( 'For all possible placeholders, see ', 'events-made-easy' ) . "<a target='_blank' href='//www.e-dynamics.be/wordpress/category/documentation/7-placeholders/7-16-taskssignups/'>" . __( 'the documentation', 'events-made-easy' ) . '</a><br>' . __( 'If you leave this empty, this mail will not be sent.', 'events-made-easy' ) );
			eme_options_textarea( __( 'Task Signup Pending Email Body', 'events-made-easy' ), 'eme_task_signup_email_body', __( 'The body of the email sent to the respondent when that person signs up for a task that requires approval.', 'events-made-easy' ) . '<br>' . __( 'For all possible placeholders, see ', 'events-made-easy' ) . "<a target='_blank' href='//www.e-dynamics.be/wordpress/category/documentation/7-placeholders/7-16-taskssignups/'>" . __( 'the documentation', 'events-made-easy' ) . '</a><br>' . __( 'If you leave this empty, this mail will not be sent.', 'events-made-easy' ), $use_html_editor, $use_full );
			eme_options_input_text( __( 'Contact Person Task Signup Pending Email Subject', 'events-made-easy' ), 'eme_cp_task_signup_email_subject', __( 'The subject of the email which will be sent to the contact person when someone signs up for a task that requires approval.', 'events-made-easy' ) . '<br>' . __( 'For all possible placeholders, see ', 'events-made-easy' ) . "<a target='_blank' href='//www.e-dynamics.be/wordpress/category/documentation/7-placeholders/7-16-taskssignups/'>" . __( 'the documentation', 'events-made-easy' ) . '</a><br>' . __( 'If you leave this empty, this mail will not be sent.', 'events-made-easy' ) );
			eme_options_textarea( __( 'Contact Person Task Signup Pending Email Body', 'events-made-easy' ), 'eme_cp_task_signup_email_body', __( 'The body of the email which will be sent to the contact person when someone signs up for a task that requires approval.', 'events-made-easy' ) . '<br>' . __( 'For all possible placeholders, see ', 'events-made-easy' ) . "<a target='_blank' href='//www.e-dynamics.be/wordpress/category/documentation/7-placeholders/7-16-taskssignups/'>" . __( 'the documentation', 'events-made-easy' ) . '</a><br>' . __( 'If you leave this empty, this mail will not be sent.', 'events-made-easy' ), $use_html_editor, $use_full );
			?>
