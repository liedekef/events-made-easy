...
<table class='form-table'>
<?php
            eme_options_textarea( __( 'Booking form format', 'events-made-easy' ), 'eme_registration_form_format', __( 'The layout of the form for bookings. #_NAME, #_EMAIL and #_SEATS are obligated fields, if not present then the form will not be shown.', 'events-made-easy' ) . '<br>' . esc_html__( 'For more information about form fields, see ', 'events-made-easy' ) . "<a target='_blank' href='//www.e-dynamics.be/wordpress/?cat=44'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a>', 1 );
            eme_options_textarea( __( 'Cancel all bookings form format', 'events-made-easy' ), 'eme_cancel_form_format', __( 'The layout of the cancel form generated by [eme_cancel_all_bookings_form], used to cancel all bookings for one event. #_NAME and #_EMAIL are obligated fields, if not present then the form will not be shown.', 'events-made-easy' ) . '<br>' . esc_html__( 'For more information about form fields, see ', 'events-made-easy' ) . "<a target='_blank' href='//www.e-dynamics.be/wordpress/?cat=5950'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a>', 1 );
            eme_options_textarea( __( 'Cancel one payment form format', 'events-made-easy' ), 'eme_cancel_payment_form_format', __( 'The layout of the cancel form generated when going to the #_CANCEL_URL (and related) placeholder, used to cancel all bookings related to 1 payment. #_SUBMIT, and #_CANCEL_PAYMENT_LINE (see the value of the next options below ) are the obligated fields, if not present then the form will not be shown.', 'events-made-easy' ) . '<br>' . esc_html__( 'For more information about form fields, see ', 'events-made-easy' ) . "<a target='_blank' href='//www.e-dynamics.be/wordpress/?cat=5950'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a>', 1 );
...
<table class='form-table'>
<?php
            eme_options_input_text( __( 'Contact Person New Event Email Subject', 'events-made-easy' ), 'eme_fs_contactperson_newevent_email_subject', __( 'The subject of the email that will be sent to the contact person when a new event is submitted.', 'events-made-easy' ) . '<br>' . esc_html__( 'For all possible placeholders, see ', 'events-made-easy' ) . "<a target='_blank' href='https://www.e-dynamics.be/wordpress/category/documentation/7-placeholders/7-2-events/'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a><br>' . __( 'If you leave this empty, this mail will not be sent.', 'events-made-easy' ) );
            eme_options_textarea( __( 'Contact Person New Event Email Body', 'events-made-easy' ), 'eme_fs_contactperson_newevent_email_body', __( 'The body of the email that will be sent to the contact person when a new event is submitted.', 'events-made-easy' ) . '<br>' . esc_html__( 'For all possible placeholders, see ', 'events-made-easy' ) . "<a target='_blank' href='https://www.e-dynamics.be/wordpress/category/documentation/7-placeholders/7-2-events/'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a><br>' . __( 'If you leave this empty, this mail will not be sent.', 'events-made-easy' ), $use_html_editor, $use_full );
...
<table class='form-table'>
<?php
            eme_options_input_text( __( 'Task Signup Pending Email Subject', 'events-made-easy' ), 'eme_task_signup_pending_email_subject', __( 'The subject of the email sent to the respondent when that person signs up for a task that requires approval.', 'events-made-easy' ) . '<br>' . esc_html__( 'For all possible placeholders, see ', 'events-made-easy' ) . "<a target='_blank' href='//www.e-dynamics.be/wordpress/category/documentation/7-placeholders/7-16-taskssignups/'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a><br>' . __( 'If you leave this empty, this mail will not be sent.', 'events-made-easy' ) );
            eme_options_textarea( __( 'Task Signup Pending Email Body', 'events-made-easy' ), 'eme_task_signup_pending_email_body', __( 'The body of the email sent to the respondent when that person signs up for a task that requires approval.', 'events-made-easy' ) . '<br>' . esc_html__( 'For all possible placeholders, see ', 'events-made-easy' ) . "<a target='_blank' href='//www.e-dynamics.be/wordpress/category/documentation/7-placeholders/7-16-taskssignups/'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a><br>' . __( 'If you leave this empty, this mail will not be sent.', 'events-made-easy' ), $use_html_editor, $use_full );
...
<?php
            ...
            eme_options_textarea( __( 'Task Signup Deleted Email Body', 'events-made-easy' ), 'eme_task_signup_trashed_email_body', __( 'The body of the email that will be sent to the respondent if the task signup is deleted by an admin.', 'events-made-easy' ) . '<br>' . esc_html__( 'For all possible placeholders, see ', 'events-made-easy' ) . "<a target='_blank' href='//www.e-dynamics.be/wordpress/category/documentation/7-placeholders/7-16-taskssignups/'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a>', $use_html_editor, $use_full );
?>
</table>
</div>
</details>
