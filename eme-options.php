...
function eme_options_register() {
	...
	switch ( $tab ) {
		...
		case 'rsvp':
			...
			break;
		case 'tasks':
			$options = [ 'eme_task_registered_users_only', 'task_only_one_signup_pp', 'eme_task_requires_approval', 'eme_task_allow_overlap', 'eme_task_form_taskentry_format', 'eme_task_form_format', 'eme_task_signup_format', 'eme_task_signup_recorded_ok_html', 'eme_task_reminder_days' ];
			break;
		case 'mail':
