...
<table class="form-table">
            <?php
                ...
                eme_options_radio_binary( __( 'Use membership feature?', 'events-made-easy' ), 'eme_members_enabled', __( 'Select yes to enable the members and membership features.', 'events-made-easy' ) );
                ...
                eme_options_radio_binary( __( 'Use Cloudflare Turnstile for forms?', 'events-made-easy' ), 'eme_cfcaptcha_for_forms', __( 'Check this option if you want to use Cloudflare Turnstile on the booking/cancel/membership forms, to thwart spammers a bit. You can then either add #_CAPTCHA to your form layout yourself or it will automatically added just above the submit button if not present.', 'events-made-easy' ) );
...
<?php
            ...
            eme_options_radio_binary( __( 'RSS Pubdate usage', 'events-made-easy' ), eme_get_field_name('eme_rss','show_pubdate'), __( 'Show the event creation/modification date as PubDate info in the in the events RSS feed.', 'events-made-easy' ), $rss_options['show_pubdate'] );
            eme_options_radio_binary( __( 'RSS Pubdate is start date', 'events-made-easy' ), eme_get_field_name('eme_rss','pubdate_startdate'), __( 'If you select this, the pubDate field in RSS will be the event start date, not the modification date.', 'events-made-easy' ), $rss_options['pubdate_startdate'] );
...
<?php
            ...
            eme_options_radio_binary( __( 'Attendees/bookings list ignore pending', 'events-made-easy' ), 'eme_attendees_list_ignore_pending', __( 'Whether or not to ignore pending bookings when using the <code>#_ATTENDEES</code> or <code>#_BOOKINGS</code> placeholders.', 'events-made-easy' ) );
...
<?php
            ...
            eme_options_textarea( __( 'Cancelled payment format', 'events-made-easy' ), 'eme_cancelled_payment_format', __( 'This options defines the format of the message shown when a payment has been cancelled. Can contain all people placeholders and #_CANCEL_PAYMENT_LINE (repeated for each booking)', 'events-made-easy' ), 1, 1 );
?>
</table>
...
<?php
            ...
            eme_options_radio_binary( __( 'By default allow only one sign up for tasks per event for a person?', 'events-made-easy' ), 'eme_task_only_one_signup_pp', __( 'Check this option if you want by default that a person can only signup for one task per event.', 'events-made-easy' ) );
...
<?php
            ...
            eme_options_radio_binary( __( 'Send paid RSVP emails immediately?', 'events-made-easy' ), 'eme_rsvp_paidmail_immediately', __( 'Check this option if you want to send out the paid emails as soon as possible and not wait for the next queue run.', 'events-made-easy' ) );
?>
</table>
<table class='form-table'>
<?php
...
<?php
    ...
    eme_options_textarea( __( 'Change personal info Form template', 'events-made-easy' ), 'eme_cpi_form', __( 'The template of the form which will be presented to the person to actually change his personal info.', 'events-made-easy' ) . '<br>' . __( 'The placeholders you can use in this setting are : #_LASTNAME, #_EMAIL, #_PHONE, #_FIRSTNAME, #_BIRTHDATE, #_BIRTHPLACE, #_ADDRESS1, #_ADDRESS2, #_CITY, #_STATE, #_ZIP, #_COUNTRY, #_OPT_IN, #_OPT_OUT, #_GDPR and all #_FIELD{xx} placeholders for custom fields of type "person".', 'events-made-easy' ), 1, 1 );
?>
</table>
...
eme_options_textarea( __( 'Default form format', 'events-made-easy' ), eme_get_field_name('eme_fs','form_format'), __( 'The default form format for submitting a new event.', 'events-made-easy' ), 1, 1, $fs_options['form_format'] );
?>
</table>
<?php
break;
