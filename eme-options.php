...
<table class='form-table'>
			...
			eme_options_input_text( __( 'Price', 'events-made-easy' ), eme_get_field_name('eme_fs','price'), __( 'The price to submit new events. Leave empty or 0 if no price is to be paid. Th currency is the default currency configured in EME. Configure the optional payment form header/footer sections in the EME Payment settings.', 'events-made-easy' ) . '<br>' . __( 'Use the point as decimal separator', 'events-made-easy' ), 'text', $fs_options['price'] );
