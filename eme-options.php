...
<?php
            ...
            if ( eme_is_datamaster() ) {
                eme_options_toggle( __( 'Use mail queuing?', 'events-made-easy' ), 'eme_queue_mails', __( 'If activated, you can plan emails for sending at a later date and time.', 'events-made-easy' ) . '<br><b>' . __( 'It is recommended to activate this option.', 'events-made-easy' ) . '</b>' );
?>
...
<?php
            ...
            eme_options_input_text( __( 'Contact Person Cancelled Booking Email Subject', 'events-made-easy' ), 'eme_contactperson_cancelled_email_subject', __( 'The subject of the email that will be sent to the contact person when a respondent cancels all his bookings for an event.', 'events-made-easy' ) . '<br>' . __( 'For all possible placeholders, see ', 'events-made-easy' ) . "<a target='_blank' href='//www.e-dynamics.be/wordpress/?cat=27'>" . __( 'the documentation', 'events-made-easy' ) . '</a><br>' . __( 'If you leave this empty, this mail will not be sent.', 'events-made-easy' ) );
...
<table class='form-table'>
<?php
            eme_options_input_text( __( 'Booking Paid Email Subject', 'events-made-easy' ), 'eme_registration_paid_email_subject', __( 'The subject of the email that will be sent to the respondent when a booking is marked as paid.', 'events-made-easy' ) . '<br>' . __( 'For all possible placeholders, see ', 'events-made-easy' ) . "<a target='_blank' href='//www.e-dynamics.be/wordpress/?cat=27'>" . __( 'the documentation', 'events-made-easy' ) . '</a><br>' . __( 'If you leave this empty, this mail will not be sent.', 'events-made-easy' ) );
            ...
            eme_options_input_text( __( 'Contact Person Paid Email Subject', 'events-made-easy' ), 'eme_contactperson_paid_email_subject', __( 'The subject of the email that will be sent to the contact person when a booking is marked as paid (not via a payment gateway).', 'events-made-easy' ) . '<br>' . __( 'For all possible placeholders, see ', 'events-made-easy' ) . "<a target='_blank' href='//www.e-dynamics.be/wordpress/?cat=27'>" . __( 'the documentation', 'events-made-easy' ) . '</a><br>' . __( 'If you leave this empty, this mail will not be sent.', 'events-made-easy' ) );
...
<?php
            ...
            eme_options_input_text( __( 'Author Payment Notification Email Subject', 'events-made-easy' ), 'eme_fs_author_ipn_email_subject', __( 'The subject of the email that will be sent to the event author (the creator normally) when a payment notification is received via a payment gateway.', 'events-made-easy' ) . '<br>' . __( 'For all possible placeholders, see ', 'events-made-easy' ) . "<a target='_blank' href='https://www.e-dynamics.be/wordpress/category/documentation/7-placeholders/7-2-events/'>" . __( 'the documentation', 'events-made-easy' ) . '</a><br>' . __( 'If you leave this empty, this mail will not be sent.', 'events-made-easy' ) );
...
<?php
    ...
    eme_options_textarea( __( 'Frontend Event Submit Payment form header format', 'events-made-easy' ), 'eme_fs_payment_form_header_format', __( 'The format of the text shown above the payment buttons if the frontend submit form for events requires payment. If left empty, a default message will be shown.', 'events-made-easy' ) . '<br>' . __( 'For all possible placeholders, see ', 'events-made-easy' ) . "<a target='_blank' href='https://www.e-dynamics.be/wordpress/event-formatting/'>" . __( 'the documentation', 'events-made-easy' ) . '</a>', 1, 1 );
    eme_options_textarea( __( 'Frontend Event Submit Payment form footer format', 'events-made-easy' ), 'eme_fs_payment_form_footer_format', __( 'The format of the text shown below the payment buttons if the frontend submit form for events requires payment.', 'events-made-easy' ) . '<br>' . __( 'For all possible placeholders, see ', 'events-made-easy' ) . "<a target='_blank' href='https://www.e-dynamics.be/wordpress/event-formatting/'>" . __( 'the documentation', 'events-made-easy' ) . '</a>', 1, 1 );
