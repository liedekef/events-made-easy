...
<?php
            ...
            eme_options_textarea( __( 'Cancel all bookings form format', 'events-made-easy' ), 'eme_cancel_form_format', __( 'The layout of the cancel form generated by [eme_cancel_all_bookings_form], used to cancel all bookings for one event. #_NAME and #_EMAIL are obligated fields, if not present then the form will not be shown.', 'events-made-easy' ) . '<br>' . esc_html__( 'For more information about form fields, see ', 'events-made-easy' ) . "<a target='_blank' href='https://www.e-dynamics.be/wordpress/eme-docs/discounts/'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a>', 1 );
            eme_options_textarea( __( 'Cancel one payment form format', 'events-made-easy' ), 'eme_cancel_payment_form_format', __( 'The layout of the cancel form generated when going to the #_CANCEL_URL (and related) placeholder, used to cancel all bookings related to 1 payment. #_SUBMIT, and #_CANCEL_PAYMENT_LINE (see the value of the next options below ) are the obligated fields, if not present then the form will not be shown.', 'events-made-easy' ) . '<br>' . esc_html__( 'For more information about form fields, see ', 'events-made-easy' ) . "<a target='_blank' href='https://www.e-dynamics.be/wordpress/eme-docs/discounts/'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a>', 1 );
