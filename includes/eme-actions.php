    ...
    if ( array_intersect( $allowed_roles, $current_user->roles ) ) {
        ...
        <div class="notice-updated notice" style="padding: 10px 10px 10px 10px; border: 1px solid #ddd; background-color:#FFFFE0;"><?php
			...
			printf(
				...
				esc_url( 'https://www.e-dynamics.be/wordpress/eme-docs/placeholders-formatting-the-content-of-events-and-locations/' ),
				esc_attr__( 'Template tags documentation', 'events-made-easy' ),
				esc_url( 'https://www.e-dynamics.be/wordpress/eme-docs/shortcodes/' ),
