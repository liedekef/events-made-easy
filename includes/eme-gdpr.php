...
function eme_gdpr_approve_show() {
	print eme_kses( eme_translate( get_option( 'eme_gdpr_approve_page_content' ) ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- eme_kses() is the plugin's escaping function for rich editor content
}
