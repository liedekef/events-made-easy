...
function eme_rpi_ajax() {
	...
	eme_check_captcha( remove_captcha_if_ok: 1 );
...
function eme_gdpr_approve_show() {
	print eme_kses( eme_translate( get_option( 'eme_gdpr_approve_page_content' ) ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- eme_kses_maybe_unfiltered() is the plugin's escaping function for rich editor content
}
