...
function eme_import_page() {
	...
	<div id="poststuff">
		...
		<p><?php esc_html_e( 'Import events from a CSV file. Required column: event_name. Optional: category_names (pipe-separated, e.g. "Music||Concerts").', 'events-made-easy' ); ?></p>
