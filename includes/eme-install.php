...
function eme_create_mqueue_table( $charset, $collate, $db_version, $db_prefix ) {
	...
	if ( ! eme_table_exists( $table_name ) ) {
		...
		maybe_add_column( $table_name, 'created_by', "ALTER TABLE $table_name ADD created_by bigint(20) unsigned DEFAULT NULL;" );
		maybe_add_column( $table_name, 'mailing_recurrence_freq', "ALTER TABLE $table_name ADD mailing_recurrence_freq varchar(20) DEFAULT '';" );
		maybe_add_column( $table_name, 'mailing_recurrence_interval', "ALTER TABLE $table_name ADD mailing_recurrence_interval tinyint DEFAULT 1;" );
		maybe_add_column( $table_name, 'mailing_recurrence_byday', "ALTER TABLE $table_name ADD mailing_recurrence_byday tinytext;" );
