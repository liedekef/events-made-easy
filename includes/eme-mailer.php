...
?>
        ...
        <b><?php esc_html_e( 'Set mailing name and start date and time', 'events-made-easy' ); ?></b><br>
                <label for='eventmail_mailing_name'><?php esc_html_e( 'Mailing name: ', 'events-made-easy' ); ?></label> <input type='text' name='eventmail_mailing_name' id='eventmail_mailing_name' value="<?php echo esc_attr( $edit_mailing_name ); ?>"><br>
...
?>
        ...
        <p>
        <b><?php esc_html_e( 'Set mailing name and start date and time', 'events-made-easy' ); ?></b><br>
                <label for='genericmail_mailing_name'><?php esc_html_e( 'Mailing name: ', 'events-made-easy' ); ?></label> <input type='text' name='genericmail_mailing_name' id='genericmail_mailing_name' value="<?php echo esc_attr( $edit_mailing_name ); ?>"><br>
                <?php esc_html_e( 'Start date and time: ', 'events-made-easy' ); ?>
