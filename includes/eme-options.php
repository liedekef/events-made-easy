...
';
    ...
    $eme_options = [
        ...
        'eme_bancontactwero_display_mode'                 => 'redirect',
        'eme_bancontactwero_qrcode_size'                  => 'M',
...
<?php
    ...
    eme_options_input_text( __( 'Text below payment button', 'events-made-easy' ), 'eme_' . $gateway . '_button_below', __( 'The text shown just below the payment button', 'events-made-easy' ) . '<br>' . esc_html__( 'For all possible placeholders, see ', 'events-made-easy' ) . "<a target='_blank' rel='noopener noreferrer' href='https://www.e-dynamics.be/wordpress/eme-docs/payment-gateway-placeholders/'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a>' );
    eme_options_select(
        __( 'Display mode', 'events-made-easy' ),
        'eme_bancontactwero_display_mode',
        [
            'redirect' => __( 'Redirect to Bancontact checkout page', 'events-made-easy' ),
            'qrcode'   => __( 'Show QR code inline on your website', 'events-made-easy' ),
        ],
        __( 'Choose whether to redirect the user to the Bancontact checkout page, or to show the QR code directly on your website so the user can scan and pay without leaving your site.', 'events-made-easy' )
    );
    eme_options_select(
        __( 'QR code size', 'events-made-easy' ),
        'eme_bancontactwero_qrcode_size',
        [
            'S'  => __( 'Small (180x180)', 'events-made-easy' ),
            'M'  => __( 'Medium (250x250)', 'events-made-easy' ),
            'L'  => __( 'Large (400x400)', 'events-made-easy' ),
            'XL' => __( 'Extra Large (800x800)', 'events-made-easy' ),
        ],
        __( 'The size of the QR code shown when using inline display mode.', 'events-made-easy' )
    );
?>
<tr><th colspan='2'><?php esc_html_e('Extra payment method information','events-made-easy'); ?></th></tr>
<?php // translators: %s is the payment notification URL ?>
