...
<table class="form-table">
            <?php
                ...
                eme_options_input_text( __( 'Google reCAPTCHA API key (Cloud project)', 'events-made-easy' ), 'eme_recaptcha_api_key', __( 'This field is required', 'events-made-easy' ) );
                eme_options_input_text( __( 'Google reCAPTCHA Cloud project ID', 'events-made-easy' ), 'eme_recaptcha_project_id', __( 'This field is required', 'events-made-easy' ) );
