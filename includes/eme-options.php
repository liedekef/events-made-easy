...
<?php
            ...
            eme_options_input_text( __( 'Attendees list format', 'events-made-easy' ), 'eme_attendees_list_format', __( 'The format for the attendees list when using the <code>#_ATTENDEES</code> placeholder.', 'events-made-easy' ) . '<br>' . esc_html__( 'For all placeholders you can use here, see ', 'events-made-easy' ) . "<a target='_blank' href='https://www.e-dynamics.be/wordpress/eme-docs/attendees-list/'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a>' );
            ...
            eme_options_input_text( __( 'Bookings list format', 'events-made-easy' ), 'eme_bookings_list_format', __( 'The format for the bookings list when using the <code>#_BOOKINGS</code> placeholder.', 'events-made-easy' ) . '<br>' . esc_html__( 'For all placeholders you can use here, see ', 'events-made-easy' ) . "<a target='_blank' href='https://www.e-dynamics.be/wordpress/eme-docs/registration-form-formatting/'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a>' . '<br>' . esc_html__( 'For more information about form fields, see ', 'events-made-easy' ) . "<a target='_blank' href='https://www.e-dynamics.be/wordpress/eme-docs/custom-attributes/'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a>' );
            // translators: %s is the default format value
...
<table class='form-table'>
<?php
            eme_options_textarea( __( 'Booking form format', 'events-made-easy' ), 'eme_registration_form_format', __( 'The layout of the form for bookings. #_NAME, #_EMAIL and #_SEATS are obligated fields, if not present then the form will not be shown.', 'events-made-easy' ) . '<br>' . esc_html__( 'For more information about form fields, see ', 'events-made-easy' ) . "<a target='_blank' href='https://www.e-dynamics.be/wordpress/eme-docs/custom-attributes/'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a>', 1 );
            eme_options_textarea( __( 'Cancel all bookings form format', 'events-made-easy' ), 'eme_cancel_form_format', __( 'The layout of the cancel form generated by [eme_cancel_all_bookings_form], used to cancel all bookings for one event. #_NAME and #_EMAIL are obligated fields, if not present then the form will not be shown.', 'events-made-easy' ) . '<br>' . esc_html__( 'For more information about form fields, see ', 'events-made-easy' ) . "<a target='_blank' href='https://www.e-dynamics.be/wordpress/eme-docs/cancel-registration-form-formatting/'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a>', 1 );
            eme_options_textarea( __( 'Cancel one payment form format', 'events-made-easy' ), 'eme_cancel_payment_form_format', __( 'The layout of the cancel form generated when going to the #_CANCEL_URL (and related) placeholder, used to cancel all bookings related to 1 payment. #_SUBMIT, and #_CANCEL_PAYMENT_LINE (see the value of the next options below ) are the obligated fields, if not present then the form will not be shown.', 'events-made-easy' ) . '<br>' . esc_html__( 'For more information about form fields, see ', 'events-made-easy' ) . "<a target='_blank' href='https://www.e-dynamics.be/wordpress/eme-docs/cancel-one-payment-form/'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a>', 1 );
...
<table class='form-table'>
<?php
            eme_options_input_text( __( 'Task Signup Pending Email Subject', 'events-made-easy' ), 'eme_task_signup_pending_email_subject', __( 'The subject of the email sent to the respondent when that person signs up for a task that requires approval.', 'events-made-easy' ) . '<br>' . esc_html__( 'For all possible placeholders, see ', 'events-made-easy' ) . "<a target='_blank' href='https://www.e-dynamics.be/wordpress/eme-docs/tasks-and-task-signup-placeholders/'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a><br>' . __( 'If you leave this empty, this mail will not be sent.', 'events-made-easy' ) );
            eme_options_textarea( __( 'Task Signup Pending Email Body', 'events-made-easy' ), 'eme_task_signup_pending_email_body', __( 'The body of the email sent to the respondent when that person signs up for a task that requires approval.', 'events-made-easy' ) . '<br>' . esc_html__( 'For all possible placeholders, see ', 'events-made-easy' ) . "<a target='_blank' href='https://www.e-dynamics.be/wordpress/eme-docs/tasks-and-task-signup-placeholders/'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a><br>' . __( 'If you leave this empty, this mail will not be sent.', 'events-made-easy' ), $use_html_editor, $use_full );
...
<?php
            ...
            eme_options_textarea( __( 'Task Signup Deleted Email Body', 'events-made-easy' ), 'eme_task_signup_trashed_email_body', __( 'The body of the email that will be sent to the respondent if the task signup is deleted by an admin.', 'events-made-easy' ) . '<br>' . esc_html__( 'For all possible placeholders, see ', 'events-made-easy' ) . "<a target='_blank' href='https://www.e-dynamics.be/wordpress/eme-docs/tasks-and-task-signup-placeholders/'>" . esc_html__( 'the documentation', 'events-made-easy' ) . '</a>', $use_html_editor, $use_full );
?>
</table>
</div>
</details>
...
<h2><?php esc_html_e( 'GDPR: General Data Protection Regulation options', 'events-made-easy' ); ?></h2>
            ...
            print esc_html__( 'For more info concerning GDPR, see', 'events-made-easy' ) . " <a target='_blank' href='https://www.e-dynamics.be/wordpress/eme-docs/eme_gdpr_approve/'>" . sprintf( esc_html__( 'the documentation about the shortcode %s', 'events-made-easy' ), esc_html( 'eme_gdpr_approve' ) ) . "</a>, <a target='_blank' href='https://www.e-dynamics.be/wordpress/eme-docs/eme_request_personal_info/'>" . sprintf( esc_html__( 'the documentation about the shortcode %s', 'events-made-easy' ), esc_html( 'eme_request_personal_info' ) ) . '</a> ' . esc_html__( 'and', 'events-made-easy' ) . " <a target='_blank' href='https://www.e-dynamics.be/wordpress/eme-docs/eme_change_personal_info/'>" . sprintf( esc_html__( 'the documentation about the shortcode %s', 'events-made-easy' ), esc_html( 'eme_change_personal_info' ) ) . '</a>'; ?>
<table class='form-table'>
<?php
    if ( get_option( 'eme_mail_send_html' ) == '1' ) {
        $use_html_editor = 1;
