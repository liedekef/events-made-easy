...
function eme_payment_form_webmoney( $item_name, $payment, $baseprice, $cur, $multi_booking = 0 ) {
    ...
    require_once dirname(__DIR__) . '/payment_gateways/webmoney/webmoney.inc.php';
...
function eme_payment_form_worldpay( $item_name, $payment, $baseprice, $cur, $multi_booking = 0 ) {
    ...
    if ( $worldpay_md5_secret ) {
        require_once dirname(__DIR__) . '/payment_gateways/worldpay/eme-worldpay.php';
...
function eme_payment_form_opayo( $item_name, $payment, $baseprice, $cur, $multi_booking = 0 ) {
    ...
    require_once dirname(__DIR__) . '/payment_gateways/opayo/eme-opayo-util.php';
...
function eme_payment_form_braintree( $item_name, $payment, $baseprice, $cur, $multi_booking = 0 ) {
    ...
    require_once dirname(__DIR__) . '/payment_gateways/braintree/vendor/autoload.php';
...
function eme_payment_form_sumup( $item_name, $payment, $baseprice, $cur, $multi_booking = 0 ) {
    ...
    require_once dirname(__DIR__) . '/payment_gateways/sumup/vendor/autoload.php';
    try {
...
function eme_payment_form_fdgg( $item_name, $payment, $baseprice, $cur, $multi_booking = 0 ) {
    ...
    require_once dirname(__DIR__) . '/payment_gateways/fdgg/fdgg-util_sha2.php';
...
function eme_payment_form_legacypaypal( $item_name, $payment, $baseprice, $cur, $multi_booking = 0 ) {
    ...
    require_once dirname(__DIR__) . '/payment_gateways/paypal_legacy/Paypal.php';
    $p = new Paypal();
...
function eme_payment_form_mercadopago( $item_name, $payment, $baseprice, $cur, $multi_booking = 0 ) {
    ...
    require_once dirname(__DIR__) . '/payment_gateways/mercadopago/vendor/autoload.php';
...
function eme_complete_transaction_instamojo( $payment ) {
    ...
    $instamojo_key        = get_option( 'eme_instamojo_key' );
    $instamojo_auth_token = get_option( 'eme_instamojo_auth_token' );
    require_once dirname(__DIR__) . '/payment_gateways/instamojo/vendor/autoload.php';
...
function eme_complete_transaction_stripe( $payment ) {
    $gateway = 'stripe';
    require_once dirname(__DIR__) . '/payment_gateways/stripe/init.php';
...
function eme_complete_transaction_paypal($payment) {
    if ( ! class_exists( 'EME_PayPal_Client' ) ) {
        require_once dirname(__DIR__) . '/payment_gateways/paypal/class_eme_paypal.php';
    }
...
function eme_complete_transaction_fondy( $payment ) {
    ...
    require_once dirname(__DIR__) . '/payment_gateways/fondy/autoload.php';
...
function eme_notification_legacypaypal() {
    $gateway = 'legacypaypal';
    require_once dirname(__DIR__) . '/payment_gateways/paypal_legacy/IPN.php';
    $ipn = new IPN();
...
function eme_charge_2co() {
    ...
    require_once dirname(__DIR__) . '/payment_gateways/2checkout/2checkout-php-sdk/autoloader.php';
    $config    = [
...
function eme_refund_booking_bancontactwero( $booking ) {
    ...
    if ( ! class_exists( 'BancontactWero\Client' ) ) {
        require_once dirname(__DIR__) . '/payment_gateways/BancontactWero/src/Client.php';
    }
...
function eme_charge_mollie() {
    ...
    if ( ! class_exists( 'Mollie\Api\MollieApiClient' ) ) {
        require_once dirname(__DIR__) . '/payment_gateways/Mollie/vendor/autoload.php';
    }
