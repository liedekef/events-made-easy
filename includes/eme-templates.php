...
?>
        ...
        <table class='form-table' id='pdf_properties'>
            ...
            <?php sprintf( __( 'See <a target="_blank" rel="noopener noreferrer" href="%s">this page</a> for info on what you can enter here.', 'events-made-easy' ), 'https://www.w3schools.com/cssref/pr_margin.asp'); ?></td>
            </tr>
