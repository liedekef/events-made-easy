        ...
        $.post(emebasic.translate_ajax_url, {
            ...
            $('a.eme-cal-prev-month, a.eme-cal-next-month').on('click', function (e) {
                ...
                loadCalendar(
                    ...
                    $(this).data('month'),
                    $(this).data('year'),
                    $(this).data('cat_chosen'),
                    $(this).data('author_chosen'),
                    $(this).data('contact_person_chosen'),
                    $(this).data('location_chosen'),
                    $(this).data('not_cat_chosen'),
                    $(this).data('template_chosen'),
                    $(this).data('holiday_chosen'),
                    $(this).data('weekdays'),
                    $(this).data('language')
                );
            });
