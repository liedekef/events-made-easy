...
= 3.1.6  (2026/07/16) =
* fix some php warnings in frontend submit
* a regex filter improvement for js removal
* language updates
...
* bugfix: make attendance checkbox work as advertised again
...
* yet more cap checks :-)
* Fix case where the github-installer could reactivate network-wide EME installation
